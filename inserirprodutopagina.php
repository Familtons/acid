...
<head>
    ...
    <body> 
        ...
        <header>
            <nav>
                <!--Logo-->
                <a class="logo"><a href="acid.php"> <img src="./icones/Meu projeto.png" width="170px" height="100x" alt=""></a> </a>
              </nav>
    </header>
                ...
                <section class="conteudo">
                    ...
                    <form action="inserirproduto.php" method="POST" enctype="multipart/form-data">
                      ...
                      <br>
                      <input name="descricao" type="text" class="caixaT" placeholder="Descriçao" > 
                      <br>
                      <input name="preco" type="text" class="caixaT" placeholder="Preço" > 
                      <br>
