        ...
        <main class="vitrine">
            <section class="catalogo">
              ...
              <section class="conteudo">
                ...
                <input name="emaillogin" type="text" class="caixaT" placeholder="E-mail" > <br>

                <input name="senhalogin" type="password" class="caixaS" placeholder="Senha"> 
                <br>

                <button> <a href="acid.html">Entrar</button> </a>
                <br>
          ...
          <section class="cadastre">
            ...
            <p>Não tem uma conta ainda? Cadastra-se agora</p>
